  ...
  return (
    <SidebarProvider>
      <div className="min-h-screen h-screen flex flex-col w-full">
        {/* Header */}
        <header className="h-16 border-b bg-white flex items-center justify-between px-2 sm:px-4 relative z-10">
          <div className="flex items-center">
            <SidebarTrigger className="mr-2 sm:mr-4" />
            <div className="flex items-center">
              <School className="h-8 w-8 text-school-primary mr-2 hidden sm:block" />
              <div>
                <h1 className="text-lg sm:text-xl font-bold text-school-primary hidden md:block">Veena Public School</h1>
        ...
        <div className="flex flex-1 min-h-0 h-0">
          ...
          <DashboardSidebar />
          {/* Main Content */}
          <main className="flex-1 p-2 sm:p-6 bg-gray-50 h-full min-h-0">
            {children}
          </main>
        </div>
      </div>
